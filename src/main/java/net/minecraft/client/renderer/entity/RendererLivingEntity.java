...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            try
            {
                ...
                if (this.renderOutlines)
                {
                    ...
                    this.renderModel(entity, f6, f5, f8, f2, f7, f4,0.0625F);
     ...
     */
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_, float partialTicks)
    {
        ...
        if (flag || flag1)
        {
            ...
            EventModelRender eventModelRender = new EventModelRender(entitylivingbaseIn,
                    () -> this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_),
                    () -> this.renderLayers(entitylivingbaseIn, p_77036_2_, p_77036_3_, partialTicks,p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_));

            eventModelRender.setEventPhase(EventPhase.PRE);
            HeliumMain.BUS.post(eventModelRender);

            eventModelRender.drawModel();
            eventModelRender.setEventPhase(EventPhase.POST);
            HeliumMain.BUS.post(eventModelRender);
